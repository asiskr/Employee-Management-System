...
# FIRST IMAGE
    img=Image.open(r"C:\Users\AsisKaur\Downloads\Helpdesk.jpg")
...
# SECOND IMAGE
    img1=Image.open(r"C:\Users\AsisKaur\Downloads\Helpdesk.jpg")
    img1=img1.resize((450,130))
    self.photoimg1=ImageTk.PhotoImage(img1)

    f_lbl=Label(self.root,image=self.photoimg1)
    f_lbl.place(x=420,y=0,width=450,height=130)

# THIRD IMAGE
    img2=Image.open(r"C:\Users\AsisKaur\Downloads\download (3).jpg")
    img2=img2.resize((450,130))
...
# BG IMAGE
    img3=Image.open(r"C:\Users\AsisKaur\Downloads\FaceDetector.jpg")
    img3=img3.resize((1280,500))
    self.photoimg3=ImageTk.PhotoImage(img3)

    f_lbl=Label(self.root,image=self.photoimg3)
    f_lbl.place(x=0,y=130,width=1280,height=500)

    title_lbl=Label(f_lbl,text="STUDENT MANAGEMENT SYSTEM",font=("times new roman",35,"bold"),bg="white",fg="black")
    title_lbl.place(x=0,y=0,width=1265,height=45)

    main_frame=Frame(f_lbl,bd=2,bg="white")
    main_frame.place(x=10,y=55,width=1240,height=430)

# LEFT LABEL FRAME
    Left_frame=LabelFrame(main_frame,bd=2,bg="white",relief=RIDGE,text="Student details",font=("times new roman",12,"bold"))
    Left_frame.place(x=10,y=10,width=600,height=580)

    img_left=Image.open(r"C:\Users\AsisKaur\Downloads\download (3).jpg")
    img_left=img_left.resize((620,130))
...
# CURRENT COURSE INFORMATION
    ...
    Current_course_frame.place(x=5,y=135,width=590,height=115)
...
# CLASS STUDENT INFORMATION
    ...
    Class_Student_frame.place(x=5,y=250,width=590,height=300)  
...
# GENDER
    ...
    gender_combo["values"]=("Male","Female","0ther")
...
# RADIO BUTTONS
    ...
    Radiobutton2=ttk.Radiobutton(Class_Student_frame,variable=self.var_radio1,text="Nake Photo Sample",value="No")
...
# BUTTON FRAMES 1
    ...
    btn_frame1.place(x=0,y=200,width=590,height=35)

    take_photo_button=Button(btn_frame1,command=self.generate_dataset,text="Take Photo Sample",width=35,font=("times new roman",12,"bold"),bg="blue",fg="white")
    take_photo_button.grid(row=0,column=0)

    update_photo_button=Button(btn_frame1,text="Update Photo Sample",width=35,font=("times new roman",12,"bold"),bg="blue",fg="white")
    update_photo_button.grid(row=0,column=1)

# RIGHT LABEL FRAME
    Right_frame=LabelFrame(main_frame,bd=2,bg="white",relief=RIDGE,text="Student details",font=("times new roman",12,"bold"))
    Right_frame.place(x=625,y=10,width=600,height=580)

    img_right=Image.open(r"C:\Users\AsisKaur\Downloads\Helpdesk.jpg")
    img_right=img_right.resize((620,130))
...
# ========= SEARCH SYSTEM ====================
    ...
    Search_frame.place(x=5,y=135,width=590,height=115) 

    search_label=Label(Search_frame,text="Search By:",font=("times new roman",12,"bold"),bg="pink",fg="white")
    ...
    search_button=Button(Search_frame,text="Search",width=12,font=("times new roman",12,"bold"),bg="pink",fg="white")
    search_button.grid(row=0,column=3,padx=2,sticky=W)

    showAll_button=Button(Search_frame,text="Show All",width=12,font=("times new roman",12,"bold"),bg="pink",fg="white")
    showAll_button.grid(row=0,column=4,padx=2,sticky=W) 

# ========= TABLE FRAME ====================
    table_frame=LabelFrame(Right_frame,bd=2,bg="white",relief=RIDGE)
    table_frame.place(x=5,y=260,width=590,height=350) 
...
class YourClassName:  # Replace YourClassName with your actual class name
    def add_data(self):
...
def generate_dataset(self):
 if self.var_dep.get()=="Select Department" or self.var_std_name.get()==""or self.var_std_id.get=="":
         ...
         try:
                    ...
                    # ======= load predefined data on face frontals froom opencv ========
